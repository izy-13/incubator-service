...
export class UsersQueryRepository {
  ...
  async findAllUsers(
    queryParams: FindAllUsersQueryDto,
  ): Promise<PaginatedResponse<UserViewModelType>> {
    const { searchEmailTerm, searchLoginTerm, sortBy, pageNumber, sortDirection, pageSize } =
      queryParams;
    ...
    return formatPaginatedResponse<UserViewModelType>({
      page: pageNumber,
      items,
      pageSize,
      totalCount,
